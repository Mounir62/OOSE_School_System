...
<div class="container">
<div class="main" style=" background-image: url('img/school_management.jpg');">
        <div class="col-2">
            <h1>Aml Lebnan</h1>
            <p>Best Education System for students</p>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-8">
				...
				<h1>Welcome to Aml Lebnan-School</h1>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-4">
				...
				<img class="teacher" src="img/arabic.jpg">
				<h3>Arabic</h3>
			...
			<div class="col-md-4">
				...
				<img class="teacher" src="img/english.jpg">
				<h3>English</h3>
			...
			<div class="col-md-4">
				...
				<img class="teacher" src="img/science.png">
				<h3>Science</h3>
	...
	<footer>
		<h3 class="footer_text">All @copyright reserved by Amr Khaled The only writer of this code</h3>
	</footer>
